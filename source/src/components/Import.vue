...
export default Vue.extend({
  props: {
    // When embedded as a popup page the initial tab comes from the view param
    // instead of the URL query.
    initialTab: {
      type: String,
      default: "",
    },
  ...
  data: function () {
    ...
    const requested = this.initialTab || query;
    const importType = ["FileImport", "QrImport", "TextImport"].includes(
      requested
    )
      ? requested
      : "FileImport";
